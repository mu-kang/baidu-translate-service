...
function BaiduTranslateService(options) {
    ...
    var sign = (0, md5_1.default)("".concat(options.appid).concat(options.q).concat(salt).concat(options.key));
    return new Promise(function (resolve, reject) {
        (0, node_fetch_1.default)(BaiduTranslateAPIUrl, {
            ...
            method: "POST",
            body: querystring_1.default.stringify(__assign(__assign(__assign({}, params), options), { salt: salt, sign: sign })),
        })
